...
function validatePromotionFields(data: Partial<Content>, errors: string[]): void {
...
function validateJobFields(data: Partial<Content>, errors: string[]): void {
...
function validateEventFields(data: Partial<Content>, errors: string[]): void {
